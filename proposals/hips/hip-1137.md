...
RegisteredNode {
    ...
    @@immutable @@nullable nodeAccountId: AccountId
...
8. Create a second `BlockNodeServiceEndpoint` with a domain name, port, TLS enabled, and `endpointApi` set to `BlockNodeApi.STATUS`.

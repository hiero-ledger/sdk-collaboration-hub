...
@@finalType
RegisteredServiceEndpoint {
    @@getSet @@nullable ipAddress: bytes
    @@getSet @@nullable domainName: string
    @@getSet port: uint32
    @@getSet @@default(false) requiresTls: bool
    @@getSet @@nullable blockNode: BlockNodeEndpoint
    @@getSet @@nullable mirrorNode: MirrorNodeEndpoint
    @@getSet @@nullable rpcRelay: RpcRelayEndpoint
}
```

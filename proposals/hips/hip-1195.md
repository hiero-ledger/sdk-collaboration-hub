...
LambdaSStoreTransaction {
    ...
    LambdaSStoreTransaction addStorageUpdate(update: LambdaStorageUpdate)
    
    // Set all storage updates for the transaction
    LambdaSStoreTransaction setStorageUpdates(updates: list<LambdaStorageUpdate>)
...
TransferTransaction {
    ...
    TransferTransaction addNftTransferWithHook(nftId: NftId, senderAccountId: AccountId, receiverAccountId: AccountId, @optional senderHookCall: NftHookCall, @optional receiverHookCall: NftHookCall)

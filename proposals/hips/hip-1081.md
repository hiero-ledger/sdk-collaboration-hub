...
### Type-to-Proto Mapping

The following table maps the SDK wrapper types defined in this document to their corresponding protobuf definitions.
...
Types for Block Node API interaction: queries, responses, configuration, and enums.
...
#### SubscribeStreamResponseCode (internal)

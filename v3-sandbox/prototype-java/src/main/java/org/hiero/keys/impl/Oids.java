...
/**
 * ASN.1 object identifiers used by the key implementations. Internal helper.
 */
final class Oids {
    ...
    static final ASN1ObjectIdentifier ID_SECP256K1 = new ASN1ObjectIdentifier("1.3.132.0.10");

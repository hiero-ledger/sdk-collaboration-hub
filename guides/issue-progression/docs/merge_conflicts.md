...
Changelog conflicts in CHANGELOG.md are common if pull requests add new entries to the "Unreleased" section at the same time.
...
### When to Use The Web Editor Method

- The conflict is simple and only in `CHANGELOG.md`.
...
**Important**: For CHANGELOG.md, "accepting both" is generally safe and recommended.
...
When conflicts involve files other than CHANGELOG.md, this is more complicated. There are two opinions on what these files should look like. You want to resolve them locally.
